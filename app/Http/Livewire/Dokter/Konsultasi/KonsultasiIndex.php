...
class KonsultasiIndex extends LivewireDatatable
{
    use PageAction;
    ...
    public function Builder(){
        ...
        return Konsultasi::query()->where('status_pembayaran','lunas')->where('status_konsultasi','belum konsultasi')->where('dokter_id',$dokter->id);
    }
    ...
    public function columns()
    {
        return [
            ...
            Column::callback(['no_telepon'], function ($no_telepon) {
                return view('components.cms.chat-sekarang', ['no_telepon' => $no_telepon, 'permissions' => $this->permission()]);
            })->unsortable()->label('hubungi pasien')
        ];
    }
