...
class FormKonsultasi extends Component
{
    ...
    {
        $permission = 'cms.' . $this->konsultasi->getTable() . '.' . $this->operation;
    ...
    {
        return redirect(route('cms.konsultasi.index'));
    }

    public function save()
    {
        if (($this->operation !== 'create') && ($this->operation !== 'update')) {
            return redirect()->to(route('cms.kategori-konsultasi.index'));
        }
