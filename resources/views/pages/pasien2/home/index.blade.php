...
@section('content')
@auth('pasien')
<div class="mt-5 flex flex-col items-center mb-20" style="background-image: url('{{asset('/home/img/logo rsia.png')}}');background-size: contain;background-repeat: no-repeat;background-position: center;">
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10 w-full px-5 md:px-44 mt-32">
        ...
        <a href="/pasien/chat" class="block bg-white py-20 shadow-2xl hover:scale-110 duration-500 transition-all" style="cursor: pointer;">
            <div class="px-5">
                <div>
    ...
    <div class="modal" id="my-modal-obat">
        <div class="modal-box">
            ...
            <div class="modal-body">
                <h1 class="text-xl">Tebus Obat</h1>
                <form action="/pasien/tebus/obat"  enctype="multipart/form-data" method="post" class="mt-10">
                    @csrf
                    <div class="flex flex-col gap-3">
                        <label for="" class="font-medium">Masukan foto resep</label>
...
@else
<div class="min-h-screen" style="background-image: url(/home/img/background.png); background-position: 0 -20px;">
    <div class="flex justify-between w-full px-20">
        ...
        <div class="w-[50%] flex justify-end mt-20">
            <div class="card bg-white p-5 shadow w-2/3">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('login-pasien') }}">
                        @csrf
                        <div class="form-control w-full mb-5">
                            <label class="label">
                                <span class="label-text uppercase font-semibold">Email Pasien</span>
                            </label>
                            <input placeholder="Email" name="email" class="input input-bordered w-full" required autofocus autocomplete="email" />
                        ...
                        <div class="form-control w-full mb-5">
                            ...
                            <input type="password" placeholder="password" class="input input-bordered w-full" name="password" required autocomplete="password" />
                    ...
                    <div class="text-center">
                        <a href="/register" class="btn btn-secondary w-1/2">Daftar</a>
                    </div>
                </div>
            </div>
        </div>
