...
<div class="card">
    <div class="card-body">
        <h4 class="card-title">Show Konsultasi #{{ $konsultasi->id }}</h4>
        ...
        <form class="forms-sample" wire:submit.prevent="save">
            ...
            @can('dokter.konsultasi.update')
                <a href="{{ route('dokter.konsultasi.edit',['konsultasi'=>$konsultasi->id]) }}" class="btn btn-warning mr-2" >Edit</a>
            @endcan
