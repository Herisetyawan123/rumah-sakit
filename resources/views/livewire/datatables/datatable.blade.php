            ...
            <div class="flex flex-wrap items-center space-x-1">
                ...
                @if($exportable)
                    ...
                    <div x-data="{ init() {
                        ...
                        <button x-on:click="window.open($wire.get('pdfExport'),'_blank')" class="flex items-center px-3 text-xs font-medium tracking-wider text-red-500 uppercase bg-white border border-red-400 space-x-2 rounded-md leading-4 hover:bg-red-200 focus:outline-none"><span>{{ __('Export PDF') }}</span>
                            <i class="fa-regular fa-file-pdf text-lg py-2.5"></i>
                    </div>
                @endif
